...
// initial catalog list (with requested items)
let CATALOG_LIST = [
  "Canva Premium",
  "ChatGPT/Gemini AI",
  "Disney+",
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Localstorage
  const STORAGE_KEY = 'saisoku_subs_v2';
  ...
  if (form) {
    form.addEventListener('submit', function(ev) {
      ...
      const modal = onlyDigits(modalEl ? modalEl.value : '');
      const harga = onlyDigits(hargaEl ? hargaEl.value : '');
